...
2 - Type cd  (include a space after "cd"), drag and drop the Morphoné folder path into the Terminal window, and press Enter.
...
4 - Open Chrome or Firefox and visit the address:
http://localhost:8000
